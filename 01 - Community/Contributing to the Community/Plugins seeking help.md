...
- [[copilot|Copilot]] - [LocalAI as default chatbot](https://github.com/logancyang/obsidian-copilot/issues/157)
...
- [[obsidian-day-planner|Day Planner]] - [Timeline always reopens at the top right sidebar when clicking status](https://github.com/ivan-lednev/obsidian-day-planner/issues/289)
...
- [[obsidian-day-planner|Day Planner]] - [[feature request] option to hide child tasks from Day Planner views](https://github.com/ivan-lednev/obsidian-day-planner/issues/234)
...
- [[obsidian-imgur-plugin|Imgur Plugin]] - [Mobile: Modal window for creating new album does not look good](https://github.com/gavvvr/obsidian-imgur-plugin/issues/57)
...
- [[khoj|Khoj]] - [Add a hint in the desktop client if the server is not up and running](https://github.com/khoj-ai/khoj/issues/505)
- [[khoj|Khoj]] - [Add try-catch blocks when indexing GitHub data](https://github.com/khoj-ai/khoj/issues/482)
...
- [[mathlinks|MathLinks]] - [Render LaTeX in the outliner](https://github.com/zhaoshenzhai/obsidian-mathlinks/issues/55)
...
- [[marp-slides|Marp Slides]] - [Add developer page in the docs](https://github.com/samuele-cozzi/obsidian-marp-slides/issues/113)
...
- [[templater-obsidian|Templater]] - [Missing Explanation of " File find TFile: <% tp.file.find_tfile("MyFile").basename %> "](https://github.com/SilentVoid13/Templater/issues/546)
- [[terminal|Terminal]] - [Open iTerm2 in Macosx?](https://github.com/polyipseity/obsidian-terminal/issues/32)
